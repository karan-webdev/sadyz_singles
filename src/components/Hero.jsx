        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
            ...
            <div className="flex-1 md:pr-10">
              ...
              <div
          className="badge-scale inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-blue/30 bg-blue/5 text-blue text-sm sm:text-sm font-medium mb-6 md:mb-8"
        >
          <Shield size={18} className="text-blue shield-flicker flex-shrink-0 mt-0" />
                <span>
